...
public class ImageActivity extends BaseActivity {
    ...
    public static void startActivity(Fragment fragment, int position, ArrayList<String> images) {
        Intent intent = new Intent(fragment.getContext(), ImageActivity.class);
        intent.putStringArrayListExtra("_images", images);
        intent.putExtra("_position", position);
